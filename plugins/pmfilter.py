        ...
        if k == False:
            ...
            if files:
                ...
                contact_admin_button = InlineKeyboardMarkup(
                    [[InlineKeyboardButton("🔰Cʟɪᴄᴋ ʜᴇʀᴇ & ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴀᴅᴍɪɴ🔰", url=GRP_LNK)]]
                )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn = [[
                ...
                InlineKeyboardButton("⚜️ Not Available In The Telugu ⚜️", callback_data=f"Not_Available_In_The_Hindi#{from_user}")
             ]]
        btn2 = [[
       ...
       #@Deendayal_dhakad
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('✨ Fʟɪᴘᴋᴀʀᴛ & Aᴍᴀᴢᴏɴ ʙᴇꜱᴛ ᴅᴇᴀʟꜱ ✨', url=f'https://t.me/amazon_flipkartt_offers')
                  ]]
